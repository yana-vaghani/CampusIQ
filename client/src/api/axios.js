...
export const getLLMSuggestions = (id) => api.get(`/students/${id}/llm-suggestions`);
...
export const exportMarksCsv = (subjectId) => `${import.meta.env.VITE_API_BASE || 'http://localhost:5000'}/api/marks/export/${subjectId}`;
...
export const gradeSubmission = (assignmentId, studentId, data) => api.put(`/assignments/${assignmentId}/submissions/${studentId}/grade`, data);

// ── LMS ───────────────────────────────────────────────────────────────
export const getLMSAll = (params) => api.get('/lms', { params });
...
export const getInterventionSuggestions = (studentId) => api.get(`/interventions/suggest/${studentId}`);
